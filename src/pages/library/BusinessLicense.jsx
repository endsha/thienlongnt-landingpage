...
export default function BusinessLicense() {
  return (
    <LibraryPage
      ...
      lead="Giấy chứng nhận đăng ký doanh nghiệp do Sở Kế hoạch & Đầu tư cấp — xác thực tư cách pháp nhân của Công ty TNHH Xây dựng và Thương mại Gia Nguyên."
      description={[
        'Giấy chứng nhận đăng ký doanh nghiệp là cơ sở pháp lý cao nhất xác lập quyền hoạt động của Gia Nguyên trong các lĩnh vực thí nghiệm vật liệu, kiểm định chất lượng và thi công xây dựng.',
